  ...
  var body: some View {
    Form {
      ...
      Section("App Behavior") {
        Toggle("Keep running after closing the editor window", isOn: $keepRunningAfterWindowClose)
        Text(
          "When enabled, MacroPad Studio remains available from the menu bar after its last editor window is closed."
        )
        .font(.caption)
        .foregroundStyle(.secondary)
      }
